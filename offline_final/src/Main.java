...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // String a="Lewis Hamilton",b="UK"
        Driver  lewis=new Driver("Lewis Hamilton",30, "UK");
        System.out.println( lewis.getName() + " Age: " + lewis.getAge() + " Country: " + lewis.getCountry());// << endl;
        ...
        c1.refuel(100);
        c1.drive(400);
        System.out.println( c1.getName() +" Manufacturer: " + c1.getManufacturer() + " Driver: " + c1.getDriver().getName() + " FuelCapacity: " + c1.getFuelCapacity());// << endl;
